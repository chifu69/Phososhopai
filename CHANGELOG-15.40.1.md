# PHOTO IA 15.40.1 — Studio interface
...
- Version and service-worker cache bumped to 15.40.1.
...
Integration: retain all remote 15.40.0 advanced selection, curves, mask and AI Fill changes; preserve the original remote 15.37.0 release notes.
