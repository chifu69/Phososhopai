const CACHE='photo-ia-13-9-layered-identity';
const VERSION='14.1';
const CORE=[
 './','./index.html','./styles.css?v=14.2-clean-wardrobe-flow','./ui-layout.js?v=14.2-clean-wardrobe-flow','./app.js?v=14.2-clean-wardrobe-flow',
 './creative-tools.js?v=14.2-clean-wardrobe-flow','./brain.js?v=14.2-clean-wardrobe-flow',
 './opencv-engine.js?v=14.2-clean-wardrobe-flow','./smart-core.js?v=14.2-clean-wardrobe-flow','./ai-studio.js?v=14.2-clean-wardrobe-flow',
 './vision.js?v=14.2-clean-wardrobe-flow','./segmentation.js?v=14.2-clean-wardrobe-flow','./manifest.webmanifest'
];
const ASSETS=[
 {local:'./assets/vendor/fabric.min.js?v=14.2-clean-wardrobe-flow',remote:'https://cdnjs.cloudflare.com/ajax/libs/fabric.js/5.3.1/fabric.min.js',name:'Editor de capas',required:true},
 {local:'./assets/vendor/cropper.min.js?v=14.2-clean-wardrobe-flow',remote:'https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.6.2/cropper.min.js',name:'Herramienta de recorte',required:true},
 {local:'./assets/vendor/cropper.min.css?v=14.2-clean-wardrobe-flow',remote:'https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.6.2/cropper.min.css',name:'Estilos de recorte',required:true},
 {local:'./assets/vendor/tf.min.js?v=14.2-clean-wardrobe-flow',remote:'https://cdn.jsdelivr.net/npm/@tensorflow/tfjs@4.22.0/dist/tf.min.js',name:'TensorFlow móvil',required:false},
 {local:'./assets/vendor/coco-ssd.min.js?v=14.2-clean-wardrobe-flow',remote:'https://cdn.jsdelivr.net/npm/@tensorflow-models/coco-ssd@2.2.3/dist/coco-ssd.min.js',name:'Detector de objetos',required:false},
 {local:'./assets/vendor/opencv.js?v=14.2-clean-wardrobe-flow',remote:'https://docs.opencv.org/4.x/opencv.js',name:'OpenCV avanzado',required:false},
