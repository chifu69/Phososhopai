...
const VERSION='13.4';
const CORE=[
 './','./index.html','./styles.css?v=13.4-selection-fix','./ui-layout.js?v=13.4-selection-fix','./app.js?v=13.4-selection-fix',
 './creative-tools.js?v=13.4-selection-fix','./brain.js?v=13.4-selection-fix',
 './opencv-engine.js?v=13.4-selection-fix','./smart-core.js?v=13.4-selection-fix','./ai-studio.js?v=13.4-selection-fix',
 './vision.js?v=13.4-selection-fix','./segmentation.js?v=13.4-selection-fix','./manifest.webmanifest'
];
const ASSETS=[
 {local:'./assets/vendor/fabric.min.js?v=13.4-selection-fix',remote:'https://cdnjs.cloudflare.com/ajax/libs/fabric.js/5.3.1/fabric.min.js',name:'Editor de capas',required:true},
 {local:'./assets/vendor/cropper.min.js?v=13.4-selection-fix',remote:'https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.6.2/cropper.min.js',name:'Herramienta de recorte',required:true},
 {local:'./assets/vendor/cropper.min.css?v=13.4-selection-fix',remote:'https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.6.2/cropper.min.css',name:'Estilos de recorte',required:true},
 {local:'./assets/vendor/tf.min.js?v=13.4-selection-fix',remote:'https://cdn.jsdelivr.net/npm/@tensorflow/tfjs@4.22.0/dist/tf.min.js',name:'TensorFlow móvil',required:false},
 {local:'./assets/vendor/coco-ssd.min.js?v=13.4-selection-fix',remote:'https://cdn.jsdelivr.net/npm/@tensorflow-models/coco-ssd@2.2.3/dist/coco-ssd.min.js',name:'Detector de objetos',required:false},
 {local:'./assets/vendor/opencv.js?v=13.4-selection-fix',remote:'https://docs.opencv.org/4.x/opencv.js',name:'OpenCV avanzado',required:false},
