const CACHE='photo-ia-12-0-mobile-pro-ui';
const VERSION='12.0';
const CORE=[
 './','./index.html','./styles.css?v=12.0-mobile-pro-ui','./ui-layout.js?v=12.0-mobile-pro-ui','./app.js?v=12.0-mobile-pro-ui',
 './creative-tools.js?v=12.0-mobile-pro-ui','./brain.js?v=12.0-mobile-pro-ui',
 './opencv-engine.js?v=12.0-mobile-pro-ui','./smart-core.js?v=12.0-mobile-pro-ui','./ai-studio.js?v=12.0-mobile-pro-ui',
 './vision.js?v=12.0-mobile-pro-ui','./segmentation.js?v=12.0-mobile-pro-ui','./manifest.webmanifest'
];
const ASSETS=[
 {local:'./assets/vendor/fabric.min.js?v=12.0-mobile-pro-ui',remote:'https://cdnjs.cloudflare.com/ajax/libs/fabric.js/5.3.1/fabric.min.js',name:'Editor de capas',required:true},
 {local:'./assets/vendor/cropper.min.js?v=12.0-mobile-pro-ui',remote:'https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.6.2/cropper.min.js',name:'Herramienta de recorte',required:true},
 {local:'./assets/vendor/cropper.min.css?v=12.0-mobile-pro-ui',remote:'https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.6.2/cropper.min.css',name:'Estilos de recorte',required:true},
 {local:'./assets/vendor/tf.min.js?v=12.0-mobile-pro-ui',remote:'https://cdn.jsdelivr.net/npm/@tensorflow/tfjs@4.22.0/dist/tf.min.js',name:'TensorFlow móvil',required:false},
 {local:'./assets/vendor/coco-ssd.min.js?v=12.0-mobile-pro-ui',remote:'https://cdn.jsdelivr.net/npm/@tensorflow-models/coco-ssd@2.2.3/dist/coco-ssd.min.js',name:'Detector de objetos',required:false},
 {local:'./assets/vendor/opencv.js?v=12.0-mobile-pro-ui',remote:'https://docs.opencv.org/4.x/opencv.js',name:'OpenCV avanzado',required:false},
