const CACHE='photo-ia-15-0-wardrobe-engine';
const VERSION='15.0';
const CORE=[
 './','./index.html','./styles.css?v=15.0-wardrobe-engine','./ui-layout.js?v=15.0-wardrobe-engine','./app.js?v=15.0-wardrobe-engine',
 './creative-tools.js?v=15.0-wardrobe-engine','./brain.js?v=15.0-wardrobe-engine',
 './opencv-engine.js?v=15.0-wardrobe-engine','./smart-core.js?v=15.0-wardrobe-engine','./wardrobe-engine.js?v=15.0-wardrobe-engine','./ai-studio.js?v=15.0-wardrobe-engine',
 './vision.js?v=15.0-wardrobe-engine','./segmentation.js?v=15.0-wardrobe-engine','./manifest.webmanifest'
];
const ASSETS=[
 {local:'./assets/vendor/fabric.min.js?v=15.0-wardrobe-engine',remote:'https://cdnjs.cloudflare.com/ajax/libs/fabric.js/5.3.1/fabric.min.js',name:'Editor de capas',required:true},
 {local:'./assets/vendor/cropper.min.js?v=15.0-wardrobe-engine',remote:'https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.6.2/cropper.min.js',name:'Herramienta de recorte',required:true},
 {local:'./assets/vendor/cropper.min.css?v=15.0-wardrobe-engine',remote:'https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.6.2/cropper.min.css',name:'Estilos de recorte',required:true},
 {local:'./assets/vendor/tf.min.js?v=15.0-wardrobe-engine',remote:'https://cdn.jsdelivr.net/npm/@tensorflow/tfjs@4.22.0/dist/tf.min.js',name:'TensorFlow móvil',required:false},
 {local:'./assets/vendor/coco-ssd.min.js?v=15.0-wardrobe-engine',remote:'https://cdn.jsdelivr.net/npm/@tensorflow-models/coco-ssd@2.2.3/dist/coco-ssd.min.js',name:'Detector de objetos',required:false},
 {local:'./assets/vendor/opencv.js?v=15.0-wardrobe-engine',remote:'https://docs.opencv.org/4.x/opencv.js',name:'OpenCV avanzado',required:false},
